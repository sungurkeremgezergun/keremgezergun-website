...
export default function NirengiContactPage() {
  return <main id="main-content" tabIndex={-1} className="nirengi-legal">
    ...
    <div className="nirengi-contact-grid"><a href="mailto:sungurkeremgezergun@gmail.com?subject=Nirengi%20Destek"><span>E-posta</span><strong>sungurkeremgezergun@gmail.com</strong></a><a href="tel:+905526902782"><span>Telefon</span><strong>+90 552 690 27 82</strong></a></div>
