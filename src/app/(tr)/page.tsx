          ...
          <div className="hero-content">
            <div className="hero-text">
              <div className="hero-badges">
                ...
                <div className="hero-badge">
                  <span className="badge-icon" aria-hidden="true">&#127942;</span>
                  <span>Emerging Talent Award Finalisti</span>
                </div>
              </div>
              <h1>
                Merhaba, ben{' '}
          ...
          <ul className="awards-grid" aria-label="Ödüller ve başarılar listesi">
            ...
            <li className="award-card">
              ...
              <p>
                ...
                <strong>&ldquo;Emerging Talent&rdquo;</strong> kategorisinde finalist oldum. Final
            ...
            <div className="podcast-info">
              ...
              <nav className="podcast-links" aria-label="Podcast platformları">
                <a
                  ...
                  rel="nofollow noopener noreferrer"
                  className="btn btn-primary"
                  aria-label="YouTube'da dinle (yeni sekmede açılır)"
                >
                ...
                <a
                  ...
                  aria-label="Spotify'da dinle (yeni sekmede açılır)"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden="true">
