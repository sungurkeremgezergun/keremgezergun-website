...
const OG_IMAGE = {
  url: `${BASE_URL}${postByPath('/turkiyenin-en-iyi-seo-uzmanlari').cover}`,
  width: 1200,
  height: 630,
...
export const metadata: Metadata = {
  ...
  alternates: alternateMetadata('/turkiyenin-en-iyi-seo-uzmanlari', '/en/best-seo-experts-in-turkey'),
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    url: PAGE_URL,
